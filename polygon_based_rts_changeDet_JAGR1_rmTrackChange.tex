...
Depending on the experiments (section \ref{sec_prepare_training}), parts of these RTS boundaries were used for training our automatic delineation method, and all of them would be considered as ground truths for validation. 
...
We did not conduct more experiments (e.g., k-fold cross-validation) using different portions of ground truths because these tend to obtain similar accuracies as proved by \cite{huang2020using}.
...
\subsubsection{RTS retreat distance based on manual delineation}
