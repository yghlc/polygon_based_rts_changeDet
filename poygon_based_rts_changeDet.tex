...
Training image are derived from multi-temporal images. 
did not include negative training polygons. 



\subsubsection{Training, Prediction, and post-processing}
\label{sec_train_prediction_post}

k-fold cross-validation. 

\subsubsection{Removing incorrect mapping results based on multi-temporal results}
\label{sec_removing_based_multi_temporal}
