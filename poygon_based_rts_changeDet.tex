...
The steps of predicting RTSs in one year includes (1) dividing it to numerous small patches, (2) predicting RTS or non-RTS pixels, (3) mosaicked the binary patches using GDAL and obtained a binary mosaic, (4) polygonizing the binary mosaic, and (5) removing polygons small than  0.3 ha. 
...
\subsubsection{Validating mapping results}
\label{sec_validation_mapping}
