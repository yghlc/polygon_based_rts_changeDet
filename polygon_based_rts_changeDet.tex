...
Therefore, in addition to the measurement of medical circles, we also conducted two other methods (section \ref{sec_cal_retreat_dis}) %(based on DEM difference and centroid of the corresponding old polygon) 
