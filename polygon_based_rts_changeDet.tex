...
The results show that the method can quantify RTS development automatically on multi-temporal images and can be potential applied to larger areas. 
...
%TODO: need o check this sentence, may not right
...
Moreover, the strategy of a generic model is more convenient and efficient than the one of multiple models when expanding the time domain. % can save a lot of computing resources, especially
...
%TODO: did I calculate the average of three AP?
