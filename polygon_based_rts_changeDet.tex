...
Accurate RTS boundaries on multi-temporal images is essential for quantifing their development.
...
alway have some mapped polygon are inaccurate, leading to the uncertainties of retreat distance. 
Even, for one-year results, some RTS boundaries are not accurate, leading to the uncertainties of retreat distance.

Why we need three automatic measurement for the retreat distance?


\subsection{Comparison with RTS retreat in the Arctic}
...
We did to things, quite indenpendent things, (1)automatica mapping on multi-temporal images. 
