...
\begin{figure} 
	...
	\caption{Precision-recall curves and average precision of mapped polygons in 2017, 2018, and 2019. (a) and (b) are precision-recall curves and AP values without and with applying the assumption of RTS dynamic features.}
...
As shown in Table S1, the F1 scores only improve a little after applying the RTS dynamic features. 
