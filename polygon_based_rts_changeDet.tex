...
To obtain the annual RTS changes, we conducted change detection for RTS boundaries between this year and the previous year, that is, comparing 2018 with 2017 and 2019 with 2018. 
 As indicated in Equation \ref{equ_polygon_diff}, for a specific location has mapped polygons in different years, a polygon in year \emph{t} minus the one in year \emph{t-1} can result in an expanding polygon or multiPolygon. 
...
Compared with the ground truths presented in Fig. S1 in the Supplementary Materials,  around 70 RTSs are missed in the mapped polygons such as the two within the yellow rectangle in Fig. \ref{table_accuracy_f1}b.
...
\begin{figure} 
	...
	\caption{Histogram of RTS expansion area and retreat distance from 2017 to 2019. (a) and (b) are expanding areas of 2017 vs 2018 and 2018 vs 2019, respectively. One RTS with an expanding area of 2.53 ha is not included in  (b). (c) and (d) are retreat distances from 2017 to 2018 and 2018 to 2019, respectively.}
...
and provides a basic tool for quantifying RTS development in large areas. 
