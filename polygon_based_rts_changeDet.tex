...
However, RTS distribution and evolution are poorly quantified because most of them scatter in remote and inaccessible areas. % due to the challenges in accurately mapping them from remote sensing images. 
...
change detection techniques to these multi-temporal RTS boundaries, we can quantify the dynamics of these RTSs and obtain their retreat distances. 
...
This is because excluding negative training polygons tends to produce more false positives but they seldom can meet the criteria of the RTS dynamic feature.  
