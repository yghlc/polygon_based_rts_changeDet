...
Therefore, it is extremely challenging, if ever possible, to measure RTS development in the field. % measurements for RTS development.
...
Firstly, we train the DeepLabv3+ (more in section \ref{sec_auto_delineating}) model using multi-temporal images then use this model to predict RTS boundaries in different years.
