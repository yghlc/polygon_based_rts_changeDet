...
Lastly, we calculate the maximum medial circles of these polygons and obtain the retreat distances based on the circles.  
...
It is underlain by ice-rich permafrost with thickness ranging from 20 to 80 m: 70\% and 20\% of this region has volumetric ice content greater than 30\% and 50\%, respectively \citep{zhou_geocryology_2000, luo_thermokarst_2015}; 
...
Therefore, in addition to the measurement of medical circles, we also conduct two other methods (based on DEM difference and centroid of the corresponding old polygon) as supplementary measurements. 
