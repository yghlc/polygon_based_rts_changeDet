...
For example, the 2018 and 2019 Planet images (Fig. \ref{fig_multi_rts_image_studyarea} c and d) are brighter than the 2017 image (Fig. \ref{fig_multi_rts_image_studyarea}b), then confuse the Deeplabv3+ model during training. 
