...
The distribution of mapped polygons for the entire Beiluhe region is shown in Fig. \ref{fig_mapping_results}a, amplifications of three locations are shown in Fig. \ref{fig_mapping_results}a, b, and c. 
...
As shown in Fig. S6, the mean difference are $-1.6$ m \& $-4.4$ m, 17.8 m \& 14.8 m, and 14.0 m \&10.6 m (2017 vs 2018 \& 2018 vs 2019) for the one based on diameter of the maximum medical circles, thee direction of the maximum elevation difference, and across the centroid of old polygons, respectively. 
...
The reason is that the manually draw lines many not exactly match the direction of RTS maximum retreat.  
...
\subsection{Accuracy of retreat distance}
